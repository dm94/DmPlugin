...
public class AutoBestAmmo implements Behavior, Configurable<BestAmmoConfig>, NpcExtraProvider {
    ...
    public AutoBestAmmo(PluginAPI api) throws SecurityException {
        this(api, api.requireAPI(HeroItemsAPI.class));
    }

    public AutoBestAmmo(PluginAPI api, HeroItemsAPI items) throws SecurityException {
        this.items = items;
