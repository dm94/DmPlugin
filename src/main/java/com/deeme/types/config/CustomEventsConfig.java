...
public class CustomEventsConfig {
    public @Option("Event 1") ExtraKeyConditionsWithoutHealth otherKey = new ExtraKeyConditionsWithoutHealth();
    public @Option("Event 2") ExtraKeyConditionsWithoutHealth otherKey2 = new ExtraKeyConditionsWithoutHealth();
